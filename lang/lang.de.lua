local L = LibStub("AceLocale-3.0.0"):NewLocale("atroxArenaViewer", "deDE")
...
L.ERROR_OLDMATCHES				= "Es können Schwierigkeiten beim Abspielen von älteren Spielen auftreten (alte SpellIds, etc.)!"
