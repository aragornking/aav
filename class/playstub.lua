...
local L = LibStub("AceLocale-3.0.0"):GetLocale("atroxArenaViewer", true)
...
function AAV_PlayStub:setMapText(mapid, game_id)
	game_id = game_id or nil
	if (type(mapid)=="number") then
		if (game_id) then
			self.maptext:SetText("[" .. tostring(game_id) .. "] " .. AAV_COMM_MAPS[mapid])
		else
